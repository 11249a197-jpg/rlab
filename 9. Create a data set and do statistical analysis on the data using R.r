...
students <- data.frame(
Name =
c("Arjun","Srihari","Lavanya","Tanvi","harsha","dhat","ashish","chandu","srinu","Lakshmi"),
Maths = c(92,90,89,95,80,88,75,92,68,86),
...
Day1 = c(6,3,7,10,2,8,6),
Day2 = c(4,2,8,12,3,7,5),
Day3 = c(6,4,6,3,1,9,7),
Day4 = c(5,3,7,11,2,7,6),
Day5 = c(7,5,5,9,5,8,8)
)
...
patients <- data.frame(
PatientID = 201:210,
Name = c("Srihari","dhathu","Ashi","chandu","srinu","Anitha","Kiran","Sneha","Gayathri","Ravi2"),
...
Salary = c(30000,70000,40000,32000,36000,42000,31000,37000,45000,33000)
)
...
ProductID = 1:10,
Product =
c("Phone","Laptop","Headset","Bag","Camera","Mouse","Keyboard","Charger","Tablet","ps5"),
Rating = c(4,5,2,4,5,4,3,5,4,4)
)
