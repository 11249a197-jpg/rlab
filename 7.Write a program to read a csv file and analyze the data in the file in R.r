...
2026-03-01 Phone Electronics 5 20000
2026-03-01 Bag Accessories 10 1500
2026-03-02 Laptop Electronics 3 50000
2026-03-02 Headset Electronics 7 2500
2026-03-03 Bag Accessories 5 1500
2026-03-03 Phone Electronics 3 20000
Goal:
1. Load the CSV file
...
Functions Used
Function Purpose
read.csv() Load CSV into R
head() Display first few rows
str() Check structure
summary() Summary statistics
trimws() Remove extra spaces
as.Date() Convert string to Date format

Function Purpose
aggregate() Group-wise calculations
which.max() Find row with maximum value
[ ] Filter rows
