...
R program:
# Data
departments <- c("CSE", "ECE", "IT", "CIVIL")
students <- c(200, 70, 50, 35)
# Pie Chart
pie(
students,
labels = departments,
main = "Student Enrollment per Department",
col = c("violet", "green", "orange", "brown")
)
# Bar Chart
barplot(
students,
...
col = c("violet", "green", "orange", "blue")
)
...
sales <- c(150000, 75500, 50000, 25000)
# Pie Chart
pie(
sales,
labels = category,
